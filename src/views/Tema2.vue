          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.bg-verde(href="https://www.marketerosagencia.com/diseno-web/fases-etapas-diseno-web/" target="_blank")
                    span Enlace web
                    i.fas.fa-link
    .titulo-segundo.mt-5
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-acento-contenido.text-white(href="https://vinkula.com/estructura-del-codigo-html5-anatomia-de-una-pagina-web/" target="_blank")
                    span Enlace web
                    i.fas.fa-link
    .h4.mt-5 CSS
    .row.mt-5
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0.text-white
                  ...
                  p.mb-0 Estimado aprendiz, para profundizar sobre el tema puede consultar la siguiente página. 
                .col-sm-auto
                  a.boton.bg-verde(href="https://www.crehana.com/co/blog/desarrollo-web/que-es-maquetacion-web/" target="_blank")
                    span Enlace web
                    i.fas.fa-link
    .row.mt-3
      .col-10.offset-1
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-acento-contenido.text-white(href="https://www.youtube.com/watch?v=VnZwBIwT4Rw&ab_channel=MaximoGuandoQuispe" target="_blank")
                    span Enlace web
                    i.fas.fa-link
    .titulo-segundo.mt-5
