  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row
      .col-md-7.mb-4
        ...
        p Finalmente, la construcción de páginas web incluye la producción de contenido que cada día toma más relevancia, al ser esta la herramienta más eficaz para fidelizar nuevos usuarios.
      .col-md-5.mb-4
          ...
          .row.m-0.align-items-center.justify-content-between
            .col-lg-8.mb-4.mb-lg-0
              .bloque-texto-a__texto.p-4
                ...
                p Para desarrollar páginas web es necesario seguir un proceso que tiene diferentes etapas, que, si se desarrollan adecuadamente, garantizan el éxito del resultado final. Este proceso está compuesto por las siguientes fases:
            .col-lg-4
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0.text-white
                  h4 “Diseño web: fases y etapas para su desarrollo”
    ...
    .row.mb-5.alto-igual
      ...
      .col-md-8.borde.m-0.py-5
        ...
        p Es así como la arquitectura web incluye pensar en sí el resultado final será un sitio que pueda resolver las necesidades de negocios y servir mejor a las necesidades de los clientes. El arquitecto web diseña y coordina el desarrollo de sitios web, ya que estos son una compleja integración de distintos sistemas (bases de datos, servidores, redes, componentes de backup y seguridad, etc.)
          br 
          | Las piezas esenciales de la arquitectura web son principalmente: servidores, bases de datos, redes, HTML, componentes de backup y seguridad, inteligencia de contenidos web, organización de componentes y organización de las llamadas a las páginas o interlinking.  
    ...
    p Los autores angloparlantes, pioneros en los temas del diseño y representación del software, dividen estos diagramas en 2 tipos: Blueprints y Wireframes. (Morville & Rosenfeld, 1998) Como sustituto del término Blueprint a veces se usa el de Architecture Map, que significa Mapa de Arquitectura.
      ...
      .row.px-lg-5(titulo="Prototipos de baja fidelidad o estáticos")
        .row
          ...
          .col-md-8
            ...
            h4.mb-0 Mockup 
            p en el proceso del diseño web el paso posterior al wireframe es el mockup, que permite tener una idea más clara de cómo se verá el sitio web. Este paso es más visual y se tienen en cuenta las dimensiones, la organización de los elementos, el texto, las imágenes, iconos, logos, etc.  
    ...
    .titulo-sexto.color-amarillo-fuerte-tercer.mb-4(data-aos="fade-right") 
      h3.mb-0 Software para hacer diagramas
    ...
    p.mb-5 Algunas aplicaciones software que fueron ideadas para hacer diagramas son:

    .row.justify-content-center
      .col-md-10
        SlyderD.mb-4(:datos="datosSlyder")

    p.mb-4 En cambio las aplicaciones software que no fueron ideadas específicamente para hacer diagramas pueden ser:
      ...
      .col-md-10
        .bloque-texto-a.color-azul2.p-4.p-md-5.mb-4
          .row.m-0.align-items-center.justify-content-between
            ...
            .col-lg-8.mb-4.mb-lg-0
              .bloque-texto-a__texto.p-4
                p Otra opción para hacer la diagramación de sitios web es la propuesta por Jesse James Garret 
                  strong (http://www.jjg.net) 
    ...
    PasosA.color-acento-contenido.azul-3.mb-5(tipo="n")
      .row
        ...
        .col-md-9
          p Entendemos el desempeño Fijar unas zonas de trabajo que soportan la estructura de contenidos del sitio web y generar los recursos necesarios que faciliten la futura carga, siempre pensando en las necesidades reales de la estructura de contenido. 
      .row
        .col-md-9
    ...
    p.mb-4 Para introducir los lenguajes de programación más usados para el diseño web, es necesario definir primero el Frontend como parte fundamental del desarrollo web, lo cual se indica a continuación:  
      ...
      .py-3.py-md-4(titulo="Frontend")
        .row
          ...
          .col-md-7
            ...
            p Frontend es la parte de una aplicación que interactúa con los usuarios; básicamente, es todo lo que se ve en la pantalla al acceder a un sitio web o aplicación: tipos de letra, colores, botones, adaptación para distintas pantallas (RWD), los efectos del ratón, teclado, movimientos, desplazamientos, menús efectos visuales y otros elementos que permiten navegar dentro de una página web. Este conjunto crea la experiencia del usuario. Esta área no trata directamente con bases de datos, servidores y todas las aplicaciones de back-end complejas, pero aborda la usabilidad, los efectos visuales y la velocidad de carga, entre otros detalles.
            p Un desarrollador frontend debe conocer, al menos, los siguientes lenguajes de programación: HTML5, CSS3, JavaScript, Jquery, Ajax. Entre los estándares más utilizados en maquetación web están los siguientes:
      ...
      .py-3.py-md-4(titulo="CSS")
        .row
          ...
          .col-md-7
            ...
            p El código CSS es utilizado para organizar la presentación y el aspecto de cualquier página web; es decir, el CSS definirá cómo van a lucir los elementos de un documento HTML. 


    .titulo-sexto.color-amarillo-fuerte-tercer.mb-4(data-aos="fade-right") 
      h3.mb-0 Estructuración técnica de un sitio web

    figure.mb-4
      img(src='@/assets/curso/tema2-3-b-img1.jpg', alt='Estructuración técnica de un sitio web')

    p.mb-4 Para estructurar un sitio web es importante tener en cuenta algunos pasos consecutivos que son claves para hacerlo de la mejor manera, pensando no solo como fijar la estructura casi a la perfección desde el punto de vista conceptual, sino también en la temática que se presentará en la página web y cómo va a ser expuesta porque sin ello es imposible crear una buena estructura después. Estos son:
        ...
        .tarjeta.color-azul-fuerte.p-3.px-lg-5
          .row.justify-content-around.align-items-center
            ...
            .col
              ...
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0.text-white
                  h4 “Maquetación de una página Web con HTML y CSS”
    ...
    .titulo-sexto.color-amarillo-fuerte-tercer.mb-4(data-aos="fade-right") 
      h3.mb-0 La web responsive

    img.mb-4(src="@/assets/curso/tema2-4-a-img1.jpg", alt="La web responsive")

    p Además de la correcta visualización y navegación, las páginas web deben adaptarse a determinaciones externas que afectan su funcionamiento en los servidores, buscadores, navegadores, etc. Tal es el caso y resulta importante mencionar, que Google, el mayor buscador de Internet, ha actualizado el sistema de calificación de sitios web para proporcionar mejores resultados de búsqueda a los usuarios que usan móviles. Dicho de otra manera, si una página web no es responsive, podría ser excluida de los resultados de búsqueda móvil de Google o clasificarse más bajo en SERP.

    p.mb-5 Con la llegada del teléfono inteligente el mundo cambió, y las páginas web también; algunas cosas se volvieron más prácticas, así como también, las páginas web. Las personas tienen conexión y acceden a la red hoy día en cualquier momento y en cualquier lugar. Por tanto, tener un sitio web optimizado para dispositivos móviles expande todas las posibilidades y abre la puerta a una audiencia más grande. De acuerdo a 
      strong Shum (2021): 
      | “En la actualidad el 70% del tráfico de internet proviene de teléfonos móviles”. 


    .titulo-sexto.color-amarillo-fuerte-tercer.mb-4(data-aos="fade-right") 
      h3.mb-0 Ventajas de tener un sitio web responsive 
